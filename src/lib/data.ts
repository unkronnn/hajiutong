...
export const gamesData: Game[] = [
  // Desktop Games
  { id: '1', name: 'Apex Legends', slug: 'apex-legends', icon: '🎮', platform: 'Desktop', productCount: 12 },
  { id: '2', name: 'Valorant', slug: 'valorant', icon: '🎯', platform: 'Desktop', productCount: 15 },
  { id: '3', name: 'CS2', slug: 'cs2', icon: '💣', platform: 'Desktop', productCount: 18 },
  { id: '4', name: 'Fortnite', slug: 'fortnite', icon: '🚀', platform: 'Desktop', productCount: 10 },
  { id: '5', name: 'Rust', slug: 'rust', icon: '🏚️', platform: 'Desktop', productCount: 8 },
  { id: '6', name: 'PUBG', slug: 'pubg', icon: '🪂', platform: 'Desktop', productCount: 14 },

  // Android Games
  { id: '7', name: 'Mobile Legends', slug: 'mobile-legends', icon: '🎭', platform: 'Android', productCount: 20 },
  { id: '8', name: 'PUBG Mobile', slug: 'pubg-mobile', icon: '🎪', platform: 'Android', productCount: 16 },
  { id: '9', name: 'Free Fire', slug: 'free-fire', icon: '🔥', platform: 'Android', productCount: 12 },
  { id: '10', name: 'Call of Duty Mobile', slug: 'cod-mobile', icon: '⚔️', platform: 'Android', productCount: 14 },
  { id: '11', name: 'Genshin Impact', slug: 'genshin-impact', icon: '⭐', platform: 'Android', productCount: 8 },

  // iOS Games
  { id: '12', name: 'Clash Royale', slug: 'clash-royale', icon: '👑', platform: 'iOS', productCount: 10 },
  { id: '13', name: 'Brawl Stars', slug: 'brawl-stars', icon: '⭐', platform: 'iOS', productCount: 12 },
  { id: '14', name: 'Honor of Kings', slug: 'honor-of-kings', icon: '🏆', platform: 'iOS', productCount: 8 },
];
